...
from vescale.dtensor._ops.utils import prod
from vescale.dtensor._utils import compute_local_shape_and_global_offset
from torch.distributed.tensor._ops._common_rules import (
    _replace_char_in_str,
    _gen_reshard_suggestions,
)
...
"""
In this file, we modified einop_rule to make it use compute_local_shape_and_global_offset.
pointwise_rule is also kept but unmodified as it uses einop_rule.
"""
