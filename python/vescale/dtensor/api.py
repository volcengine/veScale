...
def to_local(
    ...
    *,
    ...
    """
    if grad_placements is not None:
        grad_placements = normalize_placements(grad_placements, dtensor.mesh.ndim, tensor_ndim=dtensor.ndim)
...
def redistribute_dtensor(
    ...
    placements: Tuple[Placement] = normalize_placements(placements, device_mesh.ndim, tensor_ndim=dtensor.ndim)
