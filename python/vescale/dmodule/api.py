...
def parallelize_module(
    ...
    Args:
        ...
        param_sharding_plan: tha plan to specify which and how weights are sharded on device mesh during initalization.
        ...
        fwd_resharding_plan: the plan to specify which and how submodules' input/weight/output are resharded on device mesh during forward pass.
    ...
    DModule.register_sharding_plan(module, device_mesh, param_sharding_plan, fwd_resharding_plan)
